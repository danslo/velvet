...
export type GetDashboardDataQuery = { __typename?: 'Query', dashboard: { __typename?: 'Dashboard', last_orders: Array<{ __typename?: 'DashboardLastOrder', customer_name: string, num_items: number, total: string } | null>, last_search_terms: Array<{ __typename?: 'DashboardSearchTerm', results: number, search_term: string, uses: number } | null>, sales: { __typename?: 'DashboardSales', average_order: string, lifetime_sales: string }, top_search_terms: Array<{ __typename?: 'DashboardSearchTerm', results: number, search_term: string, uses: number } | null> } };
